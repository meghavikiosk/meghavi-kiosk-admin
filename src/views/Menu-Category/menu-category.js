...
const MenuCategories = () => {
  ...
  const getCategories = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.get("/api/menu-category/getCategories", {
        params: {
          // page,
          // show: itemPerPage,
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.patch(`/api/menu-category/update/${categoryId}`, formData, {
        headers: {
  ...
  const handleDelete = (_id) => {
    swal({
      ...
      if (value === true) {
        try {
          await axios.delete(`/api/menu-category/delete/${_id}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
  ...
  const handleSaveCategory = async () => {
    ...
    formData.append("categoryName", categoryName);
    try {
      await axios.post("/api/menu-category/add", formData, {
        headers: {
          Authorization: `Bearer ${token}`,
